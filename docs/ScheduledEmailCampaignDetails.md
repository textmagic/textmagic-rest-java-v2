...
|**startAt** | **OffsetDateTime** | Scheduled start timestamp (UTC). |  |
|**endAt** | **OffsetDateTime** | End timestamp for recurring campaigns (UTC). |  [optional] |
|**nextSendAt** | **OffsetDateTime** | Next scheduled send timestamp (UTC). |  [optional] |
|**createdBy** | [**UserPersonalInfo**](UserPersonalInfo.md) |  |  |
|**createdAt** | **OffsetDateTime** | Campaign creation timestamp. |  |
