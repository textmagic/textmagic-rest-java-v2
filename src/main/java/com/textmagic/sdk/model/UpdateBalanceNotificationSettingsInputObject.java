...
public class UpdateBalanceNotificationSettingsInputObject {
  ...
  **/
   ...
   * @return alertEmail1
  **/
  @ApiModelProperty(example = "test@test.com", value = "Low balance notification email 1.")
   ...
   * @return alertEmail2
  **/
  @ApiModelProperty(example = "test@test.com", value = "Low balance notification email 2.")
   ...
   * @return alertEmail3
  **/
  @ApiModelProperty(example = "test@test.com", value = "Low balance notification email 3.")
